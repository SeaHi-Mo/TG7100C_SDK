...
#include <stdint.h>
     ...
     * @return  0 : on success,  otherwise is error
     */
    int32_t hal_pwm_para_chg2(pwm_config_t para1, pwm_config_t para2);
    ...
    int32_t hal_pwm_para_chg2_BUG(pwm_dev_t *pwm1, pwm_config_t para1, pwm_dev_t *pwm2, pwm_config_t para2);
    /**
